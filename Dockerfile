...
RUN apt-get update && apt-get install -y jq curl procps openjdk-11-jre x11-xserver-utils openjfx unzip libcanberra-gtk3-module lshw libopenal1 libcanberra-gtk3-module
